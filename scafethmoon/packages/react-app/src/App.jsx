        ...
        <Switch>
          <Route exact path="/">
            <div className="">
              ...
              <h2>
                by <a href="https://twitter.com/ghostffcode">@ghostffcode</a> and{" "}
              ...
              <div className="colorme3">
                ...
                <div className="Testimonial">
                  ...
                  <h5>Simpl</h5>
                  <p>
                    bzzz bzzz bzz new fax incoming kwwaaaaaaaaaaaaaeeeeeuuuueeuuueeuuuu **denga denga** we made our
                ...
                <div className="Testimonial">
                  ...
                  <h5>Alert Desktop</h5>
                  <p>
                    Beep Boop Bop Bop Moonshot Collective is not associated with my stupid antics Beep Boop Bot Boop
                    Boop Bloop Beep Boop Boop Bloop Beep{" "}
                  </p>
                </div>
              </div>
            </div>
              ...
              <ul id="faq">
                ...
                <li>
                  <p>
                    ...
                    <br />
                    These PFPs are minted on a bonding curve that increases ~1.2% each purchase, and starts with a price
                    of 0.0033 ETH. Here new curvbe!:
                    <br />
                ...
                <li>
                  <p>
                    ...
                    <br />
                    <a href="https://gitcoin.co/grants/">Gitcoin Grants Round 12</a> starts in December! It's going to
